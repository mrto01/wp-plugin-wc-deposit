...
class Email_Deposit_Paid extends \WC_Email {
    ...
    public function __construct() {
        $this->id             = 'depart_deposit_paid';
        $this->title          = __( 'DEPART - Deposit payment received', 'depart-deposit-and-part-payment-for-woocommerce' );
        $this->description    = __( 'Deposit paid emails are sent to customer when a new Deposit order received.', 'depart-deposit-and-part-payment-for-woocommerce' );
    ...
    public function trigger( $order_id, $order = false ) {
        ...
        if ( is_a( $order, 'WC_Order' ) ) {
            ...
            if ( 'deposit' !== $order->get_meta( '_depart_partial_payment_type' ) ) {
                return false;
            }
    ...
    public function get_default_subject() {
        return esc_html__( '[{site_title}]: Your deposit order has been received!', 'depart-deposit-and-part-payment-for-woocommerce' );
    }
    
    public function get_default_heading() {
        return esc_html__( 'Thank you for your order', 'depart-deposit-and-part-payment-for-woocommerce' );
    }
    
    public function get_default_email_text() {
        return esc_html__( 'Your deposit order has been received.', 'depart-deposit-and-part-payment-for-woocommerce' );
    }
