...
class Email_Admin_Partial_paid extends \WC_Email {
	use Email_Trait;

	public function __construct() {
		$this->id             = 'depart_admin_partial_paid';
		$this->title          = __( 'DEPART - Partial paid', 'depart-deposit-and-part-payment-for-woocommerce' );
		$this->description    = __( 'Partial paid emails are sent to chosen recipient(s) when a partial payment is paid by customer', 'depart-deposit-and-part-payment-for-woocommerce' );
		$this->template_html  = 'emails/admin-partial-paid.php';
		$this->template_plain = 'emails/plain/admin-partial-paid.php';
	...
	public function get_default_subject() {
		return esc_html__( '[{site_title}]: Partial payment for #{wdp_parent_order_number}', 'depart-deposit-and-part-payment-for-woocommerce' );
	}

	public function get_default_heading() {
		return esc_html__( 'Partial payment #{wdp_suborder_number}', 'depart-deposit-and-part-payment-for-woocommerce' );
	}

	public function get_default_email_text() {
		return esc_html__( 'Partial payment #{wdp_suborder_number} for order #{wdp_parent_order_number} from {wdp_order_billing_name}.', 'depart-deposit-and-part-payment-for-woocommerce' );
	}
