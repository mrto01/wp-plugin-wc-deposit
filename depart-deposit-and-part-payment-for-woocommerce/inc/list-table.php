...
abstract class List_Table {
    ...
    public function maybe_render_blank_state( $which ) {
        ...
        if ( $post_type === $this->list_table_type && 'bottom' === $which ) {
            ...
            wp_add_inline_style('depart-list-table', '#posts-filter .wp-list-table, #posts-filter .tablenav.top, .tablenav.bottom .actions, .wrap .subsubsub  { display: none; } #posts-filter .tablenav.bottom { height: auto; }' );
