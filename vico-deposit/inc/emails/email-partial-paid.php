...
class Email_Partial_paid extends \WC_Email{
	public function __construct() {
		$this->id               = 'vicodin_Partial_paid';
		$this->title            = __( 'Partial paid', 'vico-deposit-and-installment' );
		$this->description      = __( 'Partial paid emails are sent to custom when an Partial order is paid', 'vico-deposit-and-installment' );
	...
	public function get_default_heading() {
		return __('Thank you for your order (installment)', 'vico-deposit-and-installment');
	}
	public function get_default_email_text() {
		return __('Your installment has been received.', 'vico-deposit-and-installment');
	}
